...
class listener implements EventSubscriberInterface
{
	...
	const MAX_SIZE = 50; // Max size img
	...
	public function forums_last_post_avatar($event)
	{
		...
		$forum_row['AVATAR_IMG'] = phpbb_get_user_avatar($row, $event['forum_row']['LAST_POSTER']);
...
//			print_r($topic_row);
			...
			$topic_row['LAST_POST_AUTHOR_FULL'] .= '<span class="lastpostavatar">' . phpbb_get_user_avatar($userrow, $topic_row['LAST_POST_AUTHOR']) . '</span>';
